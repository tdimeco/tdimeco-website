  ...
  <div>
    ...
    <div class="container">
      <div class="text-container">
        <img class="avatar" src="https://www.gravatar.com/avatar/7fa7d412736b54b102f5ef6274a62130?s=256" alt="Thomas Di Meco" title="Thomas Di Meco">
        ...
        <h4><span class="fa fa-desktop"></span>&nbsp; Informatique</h4>
        ...
        <h4><span class="fa fa-camera"></span>&nbsp; Astrophotographie</h4>
