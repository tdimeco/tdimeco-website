  ...
  .container
    .text-container
      ...
      ul
        ...
        li
          | #[strong Livraison et mise en production] : Le point d'orgue de toute application, la mise en production. Je peux, si vous le souhaitez, me charger de livrer l'application depuis votre espace iTunes Connect. Je peux également vous conseiller si vous souhaitez un déploiement en interne (In House).
      p
        | Concernant mes compétences techniques, je programme principalement en #[strong Swift (1, 2, 3, 4, 12, 42...)]. Je sais utiliser une grande partie des frameworks principaux d'Apple (Foundation, UIKit, Core Data/Location/Motion, CloudKit, libdispatch...). Je ne vais pas déballer la liste de tous les frameworks que j'ai utilisés, mais sachez que ça ne sera jamais un problème ou un frein si je dois en apprendre un. Concernant mon workflow, il est composé en général de #[strong Git], #[strong CocoaPods], #[strong Fastlane]..., ainsi que des outils comme #[strong POEditor], #[strong Sketch] ou #[strong Zeplin]. Mais je sais m'adapter. Je fais de la veille technologique en permanence et je me penche régulièrement sur les tendances du moment (Reactive programming, Realm, MVVM...) par curiosité, mais aussi pour voir le potentiel d'amélioration de mon workflow.
      p
